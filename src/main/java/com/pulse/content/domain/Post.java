...
public class Post {
    ...
    // factory method
    public static Post of(PostId postId, MemberId memberId, List<Long> hashTagIds, List<PostCategoryMap> postCategories, AttachId attachId, String url, FileId fileId, String title, String text, PostStatus postStatus, PostVisibility postVisibility) {
        return Post.builder()
                .postId(postId)
                .memberId(memberId)
